...
func TestNewImpression(t *testing.T) {
	t.Run("有効な文字列で生成できる", func(t *testing.T) {
		impression, err := model.NewImpression(strPtr("素晴らしい試合でした"))
		if err != nil {
	...
	t.Run("nilと空文字列は空として扱う", func(t *testing.T) {
		fromNil, err := model.NewImpression(nil)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
		...
		fromEmpty, err := model.NewImpression(strPtr(""))
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	...
	t.Run("前後の空白をトリムする", func(t *testing.T) {
		impression, err := model.NewImpression(strPtr("  感動した試合  "))
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	...
	t.Run("空白のみの文字列は空として扱う", func(t *testing.T) {
		impression, err := model.NewImpression(strPtr("   "))
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	...
	t.Run("191文字を超える文字列でエラーになる", func(t *testing.T) {
		...
		_, err := model.NewImpression(strPtr(longString))
		if err == nil {
	...
	t.Run("191文字ちょうどの文字列で生成できる", func(t *testing.T) {
		...
		impression, err := model.NewImpression(strPtr(maxString))
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
...
func TestImpressionEquals(t *testing.T) {
	t.Run("空同士が等価である", func(t *testing.T) {
		impression1, err := model.NewImpression(nil)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
		impression2, err := model.NewImpression(strPtr(""))
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	...
	t.Run("値ありと空が非等価である", func(t *testing.T) {
		impression1, err := model.NewImpression(strPtr("良い試合"))
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
		impression2, err := model.NewImpression(nil)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
	...
	t.Run("トリム後の値で等価性を比較する", func(t *testing.T) {
		...
		impression2, err := model.NewImpression(strPtr("良い試合"))
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
